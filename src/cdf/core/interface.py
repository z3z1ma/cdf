...
class PackageManifest(_CDFConfigModel):
    """Describes the outputs of a data package."""
    ...
    """Patterns for tables that are exposed to the parent project"""
...
class DataPackageConfig(_CDFConfigModel):
    ...
    """Package description, can be inherited from pyproject.toml"""
    tags: list[str] = []
    """List of tags for the package"""
    version: str = "0.1.0"
    """Semantic versioning, can be inherited from pyproject.toml"""
    ...
    """Manifest describing the data package outputs"""
...
class ProjectConfig(_CDFConfigModel):
    ...
    name: str
    """Name of the project, can be inherited from pyproject.toml"""
