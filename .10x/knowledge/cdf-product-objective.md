...
- P1, contracts and governance: row verdicts, quarantine routing, dedup, variants, trust-ring ledger events, explicit schema promotion, OpenLineage, retention/GC, signing, SBOM, and provenance.
