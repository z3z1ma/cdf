...
- Minor residual, accepted: CodeQL continues to report three pre-existing hard-coded cryptographic value findings in `crates/cdf-cli/src/tests.rs`. They are outside the D2 write scope and are owned by `.10x/tickets/2026-07-09-p1-ws5e-codeql-backfill-test-secret-fixtures.md`.
