...
- `crates/firn-conformance/src/lib.rs`
- `crates/firn-conformance/src/golden_package/mod.rs`
- `crates/firn-conformance/src/golden_package/tests.rs`
- `crates/firn-conformance/golden/prepared-orders-v1/expected.json`
- `crates/firn-conformance/Cargo.toml`
- `Cargo.lock`

## Assumptions tested

- The fixture uses public `firn-package` APIs and does not reimplement package hashing.
...
The committed fixture proves determinism on the current OS and current dependency tuple only. Cross-OS golden stability and live `firn run` package evidence are explicitly outside this ticket and remain active parent scope in `.10x/tickets/2026-07-05-conformance-chaos-golden.md`.
