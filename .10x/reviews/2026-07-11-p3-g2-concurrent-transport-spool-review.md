...
- Significant, bounded and owned: blocking Reqwest still occupies an I/O worker during transfer, and a remote native codec currently has two bounded forwarding edges. `.10x/tickets/done/2026-07-11-p3-g1-streaming-transport-byte-sources.md` owns native async HTTP/cloud byte sources; `.10x/tickets/done/2026-07-11-p3-g2-range-readahead-spool-controller.md` owns measured controller/channel consolidation.
