...
Implementation and records for `.10x/tickets/done/2026-07-06-checkpoint-store-conformance-suite.md`, including `crates/cdf-conformance/**`, the minimal `cdf-state-sqlite` test integration, `Cargo.lock`, and evidence `.10x/evidence/2026-07-06-checkpoint-store-conformance-suite.md`.
...
- SQLite-specific protection tests must remain in `cdf-state-sqlite`.
- The crate root for `cdf-conformance` must stay thin.
