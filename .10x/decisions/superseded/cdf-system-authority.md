...
The implementation will proceed by subagent-owned executable child tickets under `.10x/tickets/cancelled/2026-07-05-implement-cdf-system.md`. The parent agent acts as orchestrator: it assigns child tickets, integrates outputs, records evidence, performs review, and reconciles the record graph.
