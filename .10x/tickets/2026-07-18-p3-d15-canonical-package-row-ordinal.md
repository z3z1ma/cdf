...
- Performance retention remains the only open acceptance gate; the controlled EC2 host will measure this committed implementation before D15 closes and D14 becomes the product path.
