...
Depends-On: .10x/tickets/done/2026-07-06-package-replay-commit-gate-runtime.md, .10x/tickets/2026-07-05-cli-surface.md, .10x/tickets/2026-07-05-observability-doctor-status-sql.md
...
The exact run-ledger and commit-session contract is not yet ratified. Before implementation, the project needs explicit answers for run id minting/defaulting, run ledger storage/ownership, run-to-package/checkpoint/receipt mapping, transition ordering, multi-resource/multi-package boundaries, resume semantics, replay semantics, duplicate semantics, inspect-run redaction/verdict summary ownership, and how destination commit sessions expose durable receipt verification without bypassing destination-specific guarantees.
