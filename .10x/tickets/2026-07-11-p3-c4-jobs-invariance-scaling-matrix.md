...
- Artifact invariance: permanent jobs 1/2/auto/4 matrices cover local CSV, JSON document, NDJSON, and Parquet files; staged DuckDB and finalized Parquet destination ingress; declarative REST; and live PostgreSQL SQL-table resources. They compare package hash, canonical segment entries/ids, receipt package/segment identities, state segment identities, rows, lineage, statistics/profile artifacts, positions, verdicts, and terminal quarantine as applicable.
