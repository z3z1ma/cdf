...
- `.10x/evidence/.storage/2026-07-19-p3-d16-single-copy-stage-smoke.json`: clean `e94b5fbd` single-COPY/staged-publication falsification, exact `41,169,720` rows, `103.398522104s`, `398,165` rows/s, no spill. This proves the stage-to-target publication, not COPY handshakes, was the remaining first-load floor.
- Direct-target COPY EC2 evidence: pending.
