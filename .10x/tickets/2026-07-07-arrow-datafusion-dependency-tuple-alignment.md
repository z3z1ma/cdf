...
None from user. Implementation must follow `.10x/decisions/datafusion-git-pin-arrow59-tuple.md` and prove the tuple with golden-package and supply-chain evidence.
