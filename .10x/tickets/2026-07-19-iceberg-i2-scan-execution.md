...
- Limits: manifest-list cardinality is still resident, cancellation/generation-drift fault injection is incomplete, and performance/REST/live Glue evidence remain open in I2.
