...
- 2026-07-09: Split executable child `.10x/tickets/2026-07-09-p2-ws-b7-rest-observed-reconciliation.md` to bring declarative REST response execution onto the same observed-first JSON reconciliation and evidence-provenance path.
