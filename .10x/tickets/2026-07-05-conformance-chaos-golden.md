...
- 2026-07-06: Parent system split `.10x/tickets/2026-07-06-package-replay-firn-line-runtime.md` for the prepared-package DuckDB/SQLite receipt-verified package replay/checkpoint primitive. Chaos recovery and golden replay gates should consume that primitive rather than inventing destination/checkpoint sequencing inside conformance tests.
