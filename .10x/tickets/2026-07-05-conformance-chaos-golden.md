...
- 2026-07-06: Split child `.10x/tickets/2026-07-06-resource-conformance-suite-foundation.md` for the first reusable planning-level resource conformance harness over public `ResourceStream`/`QueryableResource` contracts, with declarative REST/SQL/file consumers. This child intentionally excludes source execution, data completeness, position replay, chaos, golden packages, and the MVP demo until the required lower-layer runtime surfaces exist.
