...
- 2026-07-06: Split child `.10x/tickets/2026-07-06-prepared-package-chaos-conformance.md` for the first deterministic chaos/replay conformance foundation over prepared DuckDB packages. It consumes the `firn-project` runtime hook to simulate the committed-before-checkpointed window without adding process-kill or CLI infrastructure.
