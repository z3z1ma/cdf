...
- 2026-07-06: Split child `.10x/tickets/2026-07-06-golden-package-conformance-foundation.md` for the first conformance-owned golden-package determinism harness. It should compare package evidence hash-by-hash against committed expectations without adding live run orchestration, archive persistence, CLI behavior, or cross-OS CI gates in the first slice.
