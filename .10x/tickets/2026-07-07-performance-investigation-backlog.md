...
- 2026-07-07: DataFusion delegation triage closed in `.10x/tickets/done/2026-07-07-datafusion-delegation-pushdown-triage.md`. It produced active decision `.10x/decisions/datafusion-tier-b-delegation-boundary.md`, open tuple owner `.10x/tickets/2026-07-07-arrow-datafusion-dependency-tuple-alignment.md`, open dependency-gated adapter owner `.10x/tickets/2026-07-07-datafusion-tableprovider-adapter.md`, and completed metadata-honesty owner `.10x/tickets/done/2026-07-07-datafusion-execution-honesty.md`.
