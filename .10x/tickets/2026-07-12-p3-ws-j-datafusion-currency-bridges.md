...
- `.10x/tickets/2026-07-12-p3-j3-expression-ir-contract-linter.md`
...
- `.10x/tickets/2026-07-11-p0-fx1-native-format-extension-boundary.md` — neutral driver prerequisite for any optional DataFusion `FileFormat` adapter
