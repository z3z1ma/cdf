...
G2 is blocked on ratifying bounded JSON probe limits, row-local warning semantics, and the Tier-0 syntax for explicit type-policy allowances. Deeper checks also depend on future WS-D/E/H source surfaces as they land.
