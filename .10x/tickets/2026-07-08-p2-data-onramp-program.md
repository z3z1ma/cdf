...
P2 does not implement a GUI, a scheduler, distributed execution, resident streaming supervisor, zip archive member semantics, or lakehouse destinations. The residual/promotion surface is explicitly scoped by the active focused specs and `.10x/tickets/done/2026-07-10-p2-residual-schema-promotion-program.md`; no broader post-load modeling surface is implied.
