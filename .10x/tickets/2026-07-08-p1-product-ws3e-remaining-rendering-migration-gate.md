...
Depends-On: .10x/tickets/done/2026-07-08-p1-product-ws3b-renderer-foundation.md, .10x/tickets/2026-07-08-p1-product-ws3c-plan-run-rendering.md, .10x/tickets/2026-07-08-p1-product-ws3d-recovery-state-backfill-rendering.md, .10x/decisions/cli-design-language-and-renderer.md
