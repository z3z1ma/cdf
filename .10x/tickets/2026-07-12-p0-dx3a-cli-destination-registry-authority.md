...
- `.10x/tickets/2026-07-11-p0-sx1-source-extension-boundary.md`, `.10x/tickets/done/2026-07-11-p0-fx1-native-format-extension-boundary.md`, and `.10x/tickets/2026-07-11-p3-b3-arrow-ipc-codecs.md` — deep-validation runtime injection, compressed/remote Arrow IPC, and discovery identity parity.
