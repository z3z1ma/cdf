...
- 2026-07-07: Activated Workstream A and ratified `.10x/decisions/superseded/commit-session-segment-write-api.md` so implementation workers have a stable kernel session contract.
...
- 2026-07-07: Shaped Workstream B with read-only inventory in `.10x/research/2026-07-07-open-orchestrator-world-inventory.md`, historical API decision `.10x/decisions/superseded/project-destination-driver-registry.md`, and four child tickets for runtime foundation, generic replay/recovery, generic project run/resolution, and caller migration/wrapper deletion.
