...
- On EC2 `c7i.4xlarge`, commit `980b8312` crossed canonical construction under a real
...
allocations. The EC2 stress rerun crossed this boundary and isolated its next failure in the
destination, so this ticket closes without absorbing the separate scheduling defect.
