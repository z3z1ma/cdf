...
- `.10x/evidence/2026-07-07-cli-run-resume-replay-inspect-spine.md`
- Child evidence records linked from the child tickets listed above.

## Review

- `.10x/reviews/2026-07-07-cli-run-resume-replay-inspect-spine-review.md`
- Earlier closure concern: `.10x/reviews/2026-07-07-cli-spine-parent-closure-audit.md`; resolved by `.10x/tickets/done/2026-07-07-cli-sql-run-success.md`.
...
- 2026-07-07: Parent closure audit recorded concerns in `.10x/reviews/2026-07-07-cli-spine-parent-closure-audit.md`: lower `cdf-project` SQL execution exists, but direct CLI table-backed SQL `run` success-path evidence was not found. Opened the child now closed at `.10x/tickets/done/2026-07-07-cli-sql-run-success.md`; this parent remained open for that final aggregate CLI-spine acceptance slice.
- 2026-07-07: CLI SQL run success child closed at `.10x/tickets/done/2026-07-07-cli-sql-run-success.md` with direct live `cdf run` evidence for a table-backed Postgres SQL source and ordered cursor. Evidence: `.10x/evidence/2026-07-07-cli-sql-run-success.md`; review: `.10x/reviews/2026-07-07-cli-sql-run-success-review.md`.
- 2026-07-07: Closed the aggregate CLI spine parent after all children were done and parent verification passed. Evidence recorded in `.10x/evidence/2026-07-07-cli-run-resume-replay-inspect-spine.md`; closure review passed in `.10x/reviews/2026-07-07-cli-run-resume-replay-inspect-spine-review.md`.
