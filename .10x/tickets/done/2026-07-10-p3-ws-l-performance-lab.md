...
- 2026-07-11: L3 wiring audit found that L1 omitted the spec-required explicit small/startup catalog cells. Follow-up `.10x/tickets/done/2026-07-11-p3-l1-small-startup-catalog-followup.md` owns the gap and gates L5, not L3.
