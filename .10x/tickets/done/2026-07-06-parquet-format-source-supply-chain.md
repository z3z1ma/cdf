...
Implement MVP Parquet file-source reads into `cdf-kernel::Batch` values with observed schema and deterministic schema hash population, without introducing a supply-chain scanner failure.
