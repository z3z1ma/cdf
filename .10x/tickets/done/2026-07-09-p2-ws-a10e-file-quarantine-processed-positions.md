...
- 2026-07-10: Activated after A10d closure. Implementation must consume the source-neutral schema-observation authority from `.10x/decisions/superseded/effective-schema-runtime-authority.md`; file-specific identity belongs at the file adapter/package presentation boundary, while processed-position and commit-gate semantics remain generic.
