...
- 2026-07-07: User ratified `.10x/decisions/superseded/project-run-postgres-destination-inputs.md`; the parent now waits only on the open Postgres implementation child, not on semantic input ambiguity. This decision was later superseded by `.10x/decisions/destination-introspection-package-and-cli-policy.md`.
