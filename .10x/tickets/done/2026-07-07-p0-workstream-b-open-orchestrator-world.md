...
- 2026-07-07: Read-only subagents inventoried public APIs/callers, module split candidates, and the smallest generic adapter shape. Historical API decision recorded in `.10x/decisions/superseded/project-destination-driver-registry.md`.
