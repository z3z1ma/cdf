...
- 2026-07-07: Activated and ratified exact API shape in `.10x/decisions/superseded/commit-session-segment-write-api.md`: synchronous `write_segment(CommitSegment) -> SegmentAck`, required `begin`, and trait-level `verify`.
