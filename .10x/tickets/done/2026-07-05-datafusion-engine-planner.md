...
Implement `cdf-engine` adapters from resources to DataFusion table providers, scan planning, pushdown negotiation, boundedness checks, physical operator chain, execution orchestration into packages, guarantee-line rendering hooks, and explain output. Owns `crates/cdf-engine/**`.
...
- `cdf explain` data includes pushed, inexact, unsupported, partition, estimate, and guarantee details.
