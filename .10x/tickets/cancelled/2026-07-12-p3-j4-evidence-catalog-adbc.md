...
Parked on 2026-07-25 because an ADBC/notebook-facing evidence catalog has no current product
consumer and should not block observability or P3 closure. Existing `cdf sql`, ledger, package,
quarantine, and lineage evidence remain intact. Reactivation should start from a concrete
read-only client and a bounded catalog surface.
