...
Depends-On: .10x/tickets/done/2026-07-05-checkpoint-store-sqlite.md, .10x/tickets/done/2026-07-05-datafusion-engine-planner.md, .10x/tickets/done/2026-07-05-conformance-chaos-golden.md, .10x/tickets/done/2026-07-07-p0-workstream-a-streaming-commit-session.md, .10x/tickets/done/2026-07-07-p0-workstream-b-open-orchestrator-world.md, .10x/tickets/done/2026-07-07-p0-workstream-c-spine-conformance-harness.md
...
Cancelled as an active ticket on 2026-07-25. The capability remains strategically valid, but this
combined CDC-source, disposition, resident-supervisor, checkpoint-cadence, and lifecycle ticket is
not a bounded current outcome. Its requirements are preserved under the continuous-execution
section of `.10x/knowledge/active-backlog-and-future-roadmap.md`. A future program MUST reuse the
completed drain-epoch, watermark, rolling-spool, receipt, and checkpoint semantics and split
concrete CDC sources from resident lifecycle execution.
