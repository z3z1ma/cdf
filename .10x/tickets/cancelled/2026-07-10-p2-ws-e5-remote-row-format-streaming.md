...
- 2026-07-10: Cancelled as a P2 implementation owner after the transport/spool/discovery/runtime semantics passed. The remaining whole-input/materialized-batch residency is explicitly absorbed by `.10x/tickets/done/2026-07-07-streaming-package-to-destination-commit-triage.md`, `.10x/tickets/done/2026-07-07-rest-json-to-arrow-performance-triage.md`, and the forthcoming P3 channel-runtime/memory-ledger work. Implementing it here would create the duplicate decoder API this ticket prohibits.
