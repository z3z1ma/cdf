...
Parked on 2026-07-25. Portable tasks, the native operator graph, isolated-worker equivalence, and
runtime telemetry are complete foundations. DataFusion `ExecutionPlan` shells and
Ballista/Spark/Flink translations belong to a deliberately activated distributed-execution
program with a real scheduler consumer; they are not P3 closure work.
