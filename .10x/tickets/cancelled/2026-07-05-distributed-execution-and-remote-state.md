...
Depends-On: .10x/tickets/done/2026-07-05-conformance-chaos-golden.md, .10x/tickets/done/2026-07-05-checkpoint-store-sqlite.md
...
Cancelled as an active ticket on 2026-07-25 because distributed scheduling, remote state stores,
lease fencing, object-store packages, and substrate evaluation are multiple future outcomes with
no currently authorized deployment target. The portable partition task, isolated-worker
equivalence, and partition-separability decisions remain the required foundation. Reactivation is
governed by the distributed-execution section of
