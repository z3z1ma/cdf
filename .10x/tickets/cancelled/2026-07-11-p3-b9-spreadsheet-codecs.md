...
Parked on 2026-07-25 because read-only workbook ingestion is a future format program, not a P3
performance-architecture closure requirement. The no-execution, date/formula/merge, hostile
archive, and bounded seek/spool requirements remain authoritative for later activation.
