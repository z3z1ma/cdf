...
Parked on 2026-07-25. A general “find something to adopt” audit is speculative and can create
work without a product need. Future DataFusion adoption begins from a named semantic or measured
performance problem, then applies the retained identity and build-graph guardrails in a focused
ticket.
