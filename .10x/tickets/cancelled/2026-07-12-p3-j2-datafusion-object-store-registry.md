...
Parked on 2026-07-25. The injected CDF transport and shared memory authorities remain complete,
but no current DataFusion session consumer requires object-store registration. A future activation
must begin from a concrete engine/catalog consumer and prove client/pool reuse without weakening
CDF credential, egress, generation, retry, cancellation, or redaction authority.
