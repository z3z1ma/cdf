...
Parked on 2026-07-25. The isolated codec crate and its test-only evidence remain useful, but Avro
is not product-registered and the current upstream decoder cannot contain dependency-owned
decompression/nested expansion under CDF's memory authority. No source-specific isolation shim
will be added without a current product need. Future activation must revalidate the upstream
bounded-decoder surface and the retained research before admitting Avro to the standard catalog.
