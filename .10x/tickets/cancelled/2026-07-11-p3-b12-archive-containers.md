...
Parked on 2026-07-25. ZIP/TAR member planning is useful future source breadth, but it is not
required to close the core Parquet/Arrow/delimited/JSON performance path. The logical-member
identity, whole-archive completion, traversal, link, bomb, nesting, and expanded-budget rules
