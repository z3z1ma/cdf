...
This evidence closes the CLI run/resume/replay/inspect spine parent only. It does not close the broader CLI surface parent `.10x/tickets/done/2026-07-05-cli-surface.md`; remaining non-run-spine command-family lower layers were later split by `.10x/tickets/done/2026-07-07-cli-remaining-command-planners.md`.
