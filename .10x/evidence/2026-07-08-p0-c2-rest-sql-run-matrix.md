...
This closes C2 only. Cross-destination chaos remains owned by `.10x/tickets/2026-07-08-p0-c3-cross-destination-chaos.md`; per-destination live-run goldens remain owned by `.10x/tickets/2026-07-08-p0-c4-live-run-goldens-per-destination.md`; property/fuzz targets remain owned by `.10x/tickets/2026-07-08-p0-c5-property-fuzz-targets.md`; Workstream C closure remains owned by `.10x/tickets/2026-07-08-p0-c6-workstream-c-closure.md`.
