...
approved JSON/JSONB, UUID, Decimal128/256, and tagged exact-text domains. The final release roofline
passed both required shapes: fixed-width at `1.027722x` and mixed text/decimal at `1.192054x` the
favorable official-client control.
