"""Preview dlt-compatible authoring shims for Firn fixtures."""
...
def resource(
    ...
    *,
    ...
    def decorate(inner: R) -> R:
        ...
        setattr(inner, "__firn_dlt_metadata__", metadata)
        return inner
...
def source(
    ...
    *,
    ...
    def decorate(inner: S) -> S:
        ...
        setattr(inner, "__firn_dlt_metadata__", metadata)
        setattr(inner, "__firn_dlt_source_name__", source_name)
        return inner
...
def bind_source(resource_func: R, source_name: str) -> R:
    metadata = getattr(resource_func, "__firn_dlt_metadata__", None)
