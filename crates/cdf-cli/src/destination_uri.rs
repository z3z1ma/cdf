...
use cdf_project::{
    DefaultSecretProvider, EnvSecretProvider, FileSecretProvider, ProjectResolutionContext,
    ResolvedProjectDestination, resolve_project_run_destination,
};
...
pub(crate) fn resolve_portable_destination(
    ...
    let secret_provider = DefaultSecretProvider::new(
    ...
    let destination =
        resolve_project_run_destination(registry, destination_uri, &destination_context)?;
