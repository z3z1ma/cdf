...
mod tests {
    ...
    use firn_kernel::{
        ...
        FirnError, PartitionId, PartitioningCapabilities, PlanId, Result, SchemaHash,
        SourcePosition, TrustLevel, WriteDisposition,
    };
    ...
    impl QueryableResource for FaultyResource {
        ...
        fn negotiate(&self, request: &ScanRequest) -> Result<ScanPlan> {
            ...
            {
                return Err(FirnError::contract("resource id mismatch"));
            }
            ...
            for predicate in &request.filters {
                match predicate.predicate_id.as_str() {
                    "p-exact" => pushed_predicates.push(firn_kernel::PushedPredicate {
                    ...
                    "p-inexact" => pushed_predicates.push(firn_kernel::PushedPredicate {
                        predicate: predicate.clone(),
