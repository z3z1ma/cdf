...
| package control-artifact buffers | metadata | cdf-package verified identity, contract-evolution, and archive-fidelity readers | identity manifest records exact bytes, but current readers allocate the complete artifact without a ledger lease | .10x/tickets/2026-07-11-p3-f2-materialization-closure-audit.md | open |
