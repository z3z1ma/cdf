...
| `CDF-PACKAGE-REPLAY-ARGUMENT` | PACKAGE | contract | 2 | replay argument | Provide the replay package destination arguments required by the destination. For Postgres replay, pass `--target schema.table`. | `cdf package verify` |
