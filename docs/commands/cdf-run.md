...
Options:
  ...
  -q, --quiet                         Suppress progress and non-primary success narration
      --plan <PATH>                   Execute a canonical portable plan artifact
  -v, --verbose...                    Show evidence detail; repeat for diagnostics
      ...
      --resume [<RUN_ID>]             Resume interrupted run authority; omit RUN_ID only when exactly one run is recoverable
