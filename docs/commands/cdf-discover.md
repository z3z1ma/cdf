...
```text
Discover source relations or authored resource schemas

Usage: cdf discover [OPTIONS] [COMMAND]

Commands:
  source    Discover relations exposed by one configured source
  resource  Discover schema for selected authored resources
